...
pub fn desktop_dir() -> Option<PathBuf> {
    dirs_sys_next::user_dir("DESKTOP")
}
pub fn document_dir() -> Option<PathBuf> {
    dirs_sys_next::user_dir("DOCUMENTS")
}
pub fn download_dir() -> Option<PathBuf> {
    dirs_sys_next::user_dir("DOWNLOAD")
}
pub fn font_dir() -> Option<PathBuf> {
    data_dir().map(|d| d.join("fonts"))
}
pub fn picture_dir() -> Option<PathBuf> {
    dirs_sys_next::user_dir("PICTURES")
}
pub fn public_dir() -> Option<PathBuf> {
    dirs_sys_next::user_dir("PUBLICSHARE")
}
pub fn template_dir() -> Option<PathBuf> {
    dirs_sys_next::user_dir("TEMPLATES")
}
pub fn video_dir() -> Option<PathBuf> {
    dirs_sys_next::user_dir("VIDEOS")
}
